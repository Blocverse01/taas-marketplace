...
const DocumentCard: FC<DocumentCardProps> = ({ documentArray, propertyName }) => {
  return (
    <div>
...
const SingleDocumentCard: FC<SingleDocumentCardProps> = ({
  fileType,
  fileURI,
  fileSize,
  label,
  ...
  return (
    <div className="flex justify-between items-center bg-t-purple p-4 rounded-lg bg-pp-green-2">
      ...
      <button
        onClick={() => downloadDocument(fileURI, label)}
        type="button"
